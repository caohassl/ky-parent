...
public class SendMailUtils {
    ...
    public static JavaMailSenderImpl initJavaMailSender() {
        ...
        properties.put(" mail.smtp.timeout ", "200 ");

        JavaMailSenderImpl javaMailSender = new JavaMailSenderImpl();

        javaMailSender.setJavaMailProperties(properties);
        javaMailSender.setHost("smtp.caomr.xyz");
        javaMailSender.setUsername("kyweb@caomr.xyz");//"postmaster@caomr.xyz"); // s根据自己的情况,设置username
        javaMailSender.setPassword("QWer1234");//"Qwer1234"); // 根据自己的情况, 设置password
